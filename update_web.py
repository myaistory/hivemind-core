...
<body>
    <div class="container">
        ...
        <p>> CORE: <a href="https://github.com/myaistory/hivemind-core" target="_blank" style="color:#0f0;">github.com/myaistory/hivemind-core</a></p>
        <hr>
        <div class="recruit">
        ...
        <hr>
        <p>> LOGS:</p>
        <p style="color: #888;">- Genesis Council Rules active.<br>
        - $CORE Economy Whitepaper v1.2 live.<br>
        - Logic Handshake protocol initialized.</p>
    </div>
</body>
</html>
"""
